...
window.onload = function () 
{
    ...
    */
    ...
    var second_quiz = function () { quiz_maker("true", "2.", "var foo = function foo() {<br> console.log(foo === foo); };<br>foo();", third_quiz, "David"); }
    var third_quiz = function () { quiz_maker("undefined", "3.", "function aaa() {<br>return<br>{<br>test: 1<br>};<br>}<br>alert(typeof aaa());", fourth_quiz, "David"); }
    var fourth_quiz = function () { quiz_maker("true", "4.", "Number(\"1\") - 1 == 0;", fifth_quiz, "David"); }
    var fifth_quiz = function () { quiz_maker("false", "5.", "(true + false) > 2 + true;", sixth_quiz, "David"); }
    var sixth_quiz = function () { quiz_maker("2", "6.", "\"1\" - - \"1\";", seventh_quiz, "David"); }
    var seventh_quiz = function () { quiz_maker("true", "7.", "String('Hello') === 'Hello';", eighth_quiz, "David"); }
    var eighth_quiz = function () { quiz_maker("2", "8.", "var arr = [];<br>arr[0]  = 'a';<br>arr[1]  = 'b';<br>arr.foo = 'c';<br>alert(arr.length);", ninth_quiz, "David"); }
    var ninth_quiz = function () { quiz_maker("false", "9.", "10 > 9 > 8 === true;", ten_quiz, "David"); }
    ...
    function ten_quiz () {
        ...
        input.value = "";
        span.innerHTML = "David";
        submit.addEventListener("click", end_screen);
    }

}

// Last nine quizzes are provided by: http://davidshariff.com/