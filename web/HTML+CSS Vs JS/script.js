...
$(function(){
$("body").html("<div class='circle'></div><div class='span'></div>Original code<a href='https://code.sololearn.com/WoyDXZiZ7Pog/'> here</a>");
$(".circle").css({"width":"17px","height":"17px","border-radius":"50%","border-color":"transparent","background-color":"#000","z-index":10});
