...
$(".status").html("last seen June 12, 2017");
...
isInArray(bad, lastmsg)==true?smsg="Thanks for your precious feedback, I'll try to improve that.😇":
...
lastmsg.substring(0, 5)==="SEARCH"?search=search.slice(7):
(smse=["I didn't understand, please explain it with proper spellings or  If you say so I can search for you. To search, <br> type <q><b> Search Your keyword </b></q> for example type :<br> <b>Search Sololearn</b>", "<b align='center'>This are the top results </b><nav class='back'  onclick='history.back()'>&larr;</nav><nav class='forword' onclick='history.forward()'>&rarr;</nav><iframe style = 'z-index:1;overflow-x:scroll; overflow-y:scroll;' scrolling='yes' height='300px' width='100%' src='https://www.bing.com/search?q="+search+"'></iframe>"],
smsg=smse[Math.floor(Math.random()*1)]);
