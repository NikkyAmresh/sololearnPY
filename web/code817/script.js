...
window.onload = alert("This is a simple Match3 Game.\n\nIf you're confused, you can choose \"Show Moves\" option.\nIf you want the AI to play this game, tap on \"Enable AI Bot\".\n\nPost your score in the comments.\nHope you would enjoy it ^_^");
...
window.onload = function() {
    ...
    // Gui buttons
    var buttons = [ { x: 15, y: 240, width: 80, height: 30, text: "New Game"},
                    { x: 15, y: 300, width: 80, height: 30, text: "Show Moves"},
                    { x: 15, y: 360, width: 100, height: 30, text: "Enable AI Bot"}];
    ...
    function render() {
        ...
        drawCenterText("Score:", 10, level.y+40, 100);
        drawCenterText(score, 10, level.y+70, 100);
    ...
    function drawFrame() {
        ...
        // Draw title
        context.fillStyle = "#ffffff";
        context.font = "22px 'Bree Serif', serif";
        context.fillText("Match The Colors", 150, 30);
        
        // Display fps
        context.fillStyle = "#ffffff";
        context.font = "12px 'Asap', sans-serif";
        context.fillText("Fps: " + fps, 230, 50);
    }
