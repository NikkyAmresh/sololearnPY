// Created by ✔️CloudCoder

// Created by Asiri

var config = {
     apiKey: "AIzaSyCjvb4lAw0kkhzlC4qlEObjyQjq8C7DXGc",
    authDomain: "spytalk-87d37.firebaseapp.com",
    databaseURL: "https://spytalk-87d37.firebaseio.com",
    projectId: "spytalk-87d37",
    storageBucket: "spytalk-87d37.appspot.com",
    messagingSenderId: "431836148286"
  };
...
var user = firebase.auth().currentUser;
   var name="<span style='background:#f00;color:#fff;padding-top;100px;text-align:center;position:fixed;top:0;font-size:50px;z-index:1;left:0px;width:100%;height:10000px'>LOL 😂😂 </span>";
...
//photo_update($("#email").val());
    ...
    user.providerData.forEach(function (profile) {var name5=profile.displayName;
          ...
          name_update(); $("img.avatar").attr("src","https://api.sololearn.com/Uploads/Avatars/"+profile.photoURL+".jpg");
