...
  errm(error.message);
    ...
    firebase.auth().onAuthStateChanged(
     ...
     var g=firebase.database().ref().child('msg').limitToLast(10);;
g.on('child_added', snap =>{
 ...
 para = "<div class='message sent'>"+convert(me)+"</div>";
    ...
    para ="<div class='message received'><span align='left' style='font-size:12px;color:#a33'>"+uname+"</span><br>"+convert(me)+"</div>";
  }}}
  $("#ap").append(para);
});
