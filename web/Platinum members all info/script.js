...
function read(e){
    var r=(new DOMParser).parseFromString(e,"text/html").querySelector("body");
        ...
        document.getElementById(r).innerHTML+="<li><img class='av' onerror='imgError(this);' src='https://api.sololearn.com/Uploads/Avatars/"+e+".jpg' style='border-radius:50%;height:82px;'> <br><a target='_blank' href='https://www.sololearn.com/Profile/"+e+"'>"+n.name+"</a> <br>Level : "+n.level+" <br>"+n.xp+" </li>",
        count++,
        $("#loader").hide(),
        count>135&&$(".hide").hide()
        }};
        ...
        $(function(){
        for(i=0;i<56;i++)$("p")[i].click()
       alert("For 130+ CROS, you need have to at least 4G connection");
        alert("Loading... ");
        alert("Profile pic, Name, level and xp \n all are real-time data...😉");
        });
