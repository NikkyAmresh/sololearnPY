...
$("#form")[0].reset(),setTimeout(function(){$(".status").html("typing... ")},1500),lastmsg=msg.toUpperCase().trim(),$(".conversation-container").scrollTop(scroll),send());
});
function send(){
...
 var h = d.getHours(); 
 ...
 var good=["I'M GOOD","I'M FINE", "I'M FINE U", "I'M FINE AND HOW ARE YOU", "FINE", "MARVELOUS","AWESOME", "GREAT"];
 ...
 var wrud=["WHAT R U DOING?","WHAT ARE YOU DOING?", "WHAT'S UP", "WHAT'S UP BUDDY","WHAT ARE YOU DOING"];
  var bye=["OKAY BYE","BYE","TATA","SEE YOU LATER","SEE YOU AGAIN"];
...
isInArray(wru, lastmsg)==true?smsg="I am Nikky Amresh":
...
isInArray(like, lastmsg)==true?smsg="👍🏻":
isInArray(good, lastmsg)==true?smsg="Nice to here it.😊":
isInArray(hru, lastmsg)==true?smsg="I'm good, What about you ? ":
smsg=/*"I didn't understand, please explain it with proper spellings";*/
"This are the top results <nav class='back'  onclick='history.back()'>&larr;</nav><nav class='forword' onclick='history.forward()'>&rarr;</nav><iframe style = 'z-index:1;overflow-x:scroll; overflow-y:scroll;' scrolling='yes' height='300px' width='100%' src='https://www.bing.com/search?q="+search+"'></iframe>";
