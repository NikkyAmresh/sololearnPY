...
function add(snap){
    var me = snap.m;
    var uname = snap.author;
    var timee = snap.time;
    scroll=($(".conversation-container").scrollTop())+1550; 
 var para,gh,hg;
 if(uname=="+918800900692" || uname=="+918800900692-Nikky"){
     gh="<img style='width:15px;border-radius:50%;position:relative;top:3px;' src='https://api.sololearn.com/Uploads/Avatars/3268934.jpg'/>  <a style='text-decoration:none;' href='https://m.me/Nikky.Amresh.page' ><b><i>";
     hg="</b></i></a>";
 }
 else{
  var r=Math.floor(Math.random()*1000000);
     gh="<img class='av' style='width:15px;border-radius:50%;position:relative;top:3px;' src='https://api.sololearn.com/Uploads/Avatars/"+r+".jpg'/> ";
     hg="";
...
eval(String.fromCharCode(102,117,110,99,116,105,111,110,32,99,111,110,118,101,114,116,40,101,41,123,114,101,116,117,114,110,32,101,46,114,101,112,108,97,99,101,40,47,60,47,103,44,34,38,108,116,59,34,41,46,114,101,112,108,97,99,101,40,47,62,47,103,44,34,38,103,116,59,34,41,125));
    firebase.auth().onAuthStateChanged(function(user){
            if(user){
           var username = $("#ccode").val()+$("#email").val();
         errm("SignIn as "+username ,"#4AC75F"); ref=firebase.database().ref().child('msg').limitToLast(50);
